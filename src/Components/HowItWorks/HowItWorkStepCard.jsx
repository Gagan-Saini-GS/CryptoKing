...
const HowItWorkStepCard = ({ image, title, description }) => {
  return (
    <div
      className="border border-Gray p-2 md:p-4 rounded-md flex flex-col items-center justify-center shadow-none hover:shadow-sm hover:bg-LightGray hover:bg-opacity-10 hover:cursor-pointer"
